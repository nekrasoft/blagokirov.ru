...
$pageTitle = 'Вывоз мусора для предприятий в Кирове | Регулярное обслуживание объектов';
$pageDescription = 'Вывоз мусора для предприятий в Кирове: плановое обслуживание территорий, контейнеры 8 м3, акты, УПД и подтверждение утилизации.';
$canonicalUrl = get_canonical_url('vyvoz-musora-dlya-predpriyatiy');
$ogImage = SITE_URL . '/assets/blago-truck-shacman-2.jpg';

$serviceSchema = [
    '@context' => 'https://schema.org',
    '@type' => 'Service',
    'serviceType' => 'Вывоз мусора для предприятий',
    'provider' => [
        '@type' => 'LocalBusiness',
        'name' => COMPANY_NAME,
        'telephone' => PHONE_1
...
$breadcrumbSchema = [
    ...
    'itemListElement' => [
        ...
        [
            '@type' => 'ListItem',
            'position' => 3,
            'name' => 'Вывоз мусора для предприятий',
            'item' => $canonicalUrl
        ]
    ]
];
...
<main style="max-width: 1200px; margin: 0 auto; padding: 40px 20px;">
    ...
    <h1 style="font-size: 36px; color: #2c3e50; margin-bottom: 20px; text-align: center;">
        Вывоз мусора для предприятий в Кирове
    </h1>

    <p style="font-size: 18px; color: #555; text-align: center; margin-bottom: 40px;">
        Обслуживаем производственные и складские площадки, торговые и коммерческие объекты:
        регулярный график вывоза, контейнерные решения и полный пакет документов.
    </p>

    <section style="margin-bottom: 50px;">
        <div style="display:flex; gap:30px; flex-wrap:wrap; align-items:flex-start;">
            <div style="flex:0 0 320px; max-width:320px;">
                <img src="<?php echo SITE_URL; ?>/assets/blago-truck-shacman-2.jpg" alt="Вывоз мусора для предприятий в Кирове" style="width:100%; border-radius:10px; box-shadow:0 4px 8px rgba(0,0,0,0.1);">
            </div>
            <div style="flex:1 1 480px; min-width:280px;">
                <h2 style="font-size:28px; color:#2c3e50; margin-top:0; margin-bottom:16px;">Как организуем обслуживание</h2>
                <ul style="margin:0; padding-left:20px; color:#333; line-height:1.9;">
                    <li>Регулярный вывоз по графику смен или недельному плану</li>
                    <li>Подключение контейнера 8 м3 под накопление отходов</li>
                    <li>Резервные выезды при пиковых объемах</li>
                    <li>Документооборот для бухгалтерии и службы охраны труда</li>
                </ul>
            </div>
        </div>
    </section>
    ...
    <section style="margin-bottom: 50px; background:#f8f9fa; border-radius:10px; padding:30px;">
        <h2 style="font-size:28px; color:#2c3e50; margin-bottom:20px;">Форматы и тарифы</h2>
        <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(260px, 1fr)); gap:20px;">
            ...
            <div style="background:#fff; border-radius:8px; padding:20px; border:1px solid #e7edf3;">
                ...
                <p style="margin:0; color:#666;">за 1 м3 для точечных и сезонных задач</p>
            </div>
            <div style="background:#fff; border-radius:8px; padding:20px; border:1px solid #e7edf3;">
                ...
                <p style="margin:0; color:#666;">когда требуется гибкий график подачи техники</p>
            </div>
        </div>
    </section>
    ...
    <section style="background: linear-gradient(135deg, #007bff 0%, #0056b3 100%); color:#fff; padding:40px 20px; border-radius:10px; margin-bottom:50px;">
        <div class="cta-grid" style="max-width:1200px; margin:0 auto; display:grid; grid-template-columns:1fr 1fr; gap:40px; align-items:start;">
            <div>
                <h2 style="font-size:32px; margin-bottom:20px; text-align:center;">Подготовим коммерческие условия под ваш объект</h2>
                <p style="font-size:18px; margin-bottom:25px; text-align:center;">Согласуем график вывоза, формат оплаты и закрывающие документы для вашей компании.</p>
            ...
            <div>
                <?php
                $formType = 'order';
                $pageName = 'Вывоз для предприятий';
